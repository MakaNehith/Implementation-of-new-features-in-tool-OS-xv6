...
test_pa4_18(void)
{
    ...
    printf("  HI-priority: disk_reads=%d disk_writes=%d latency=%ld.%ld\n",
    ...
    printf("  LO-priority: disk_reads=%d disk_writes=%d latency=%ld.%ld\n",
...
test_pa4_19(void)
{
    ...
    getvmstats(pid, &st2);
    printf("  Scattered SSTF: disk_reads=%d disk_writes=%d avg_lat=%ld.%ld\n",
...
test_pa4_21(void)
{
    ...
    printf("  Disk stats: disk_reads=%d disk_writes=%d latency=%ld.%ld\n",
...
test_pa4_22(void)
{
    ...
    printf("  FCFS: disk_reads=%d disk_writes=%d avg_lat=%ld.%ld ticks\n",
    ...
    printf("  SSTF (cumulative): disk_reads=%d disk_writes=%d avg_lat=%ld.%ld ticks\n",
